...
export const createTaxSchema = z.object({
  body: z.object({
    ...
    conditions: z.object({
      ...
      specificItems: z.array(z.string().regex(objectIdRegex, 'Invalid Item ID format')).optional(),
      specificCategories: z.array(z.string().regex(objectIdRegex, 'Invalid Category ID format')).optional(),
    }).optional(),

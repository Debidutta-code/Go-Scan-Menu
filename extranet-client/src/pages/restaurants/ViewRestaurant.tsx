          ...
          <div className="info-item">
            ...
            <p className="info-value">
              <span className={`plan-badge plan-${restaurant.subscription.plan}`}>
                {restaurant.subscription.plan.charAt(0).toUpperCase() +
                  restaurant.subscription.plan.slice(1)}
              </span>
            </p>
          </div>
          <div className="info-item">
            ...
            <p className="info-value">
              <span
                className={`status-badge ${restaurant.subscription.isActive ? 'active' : 'inactive'}`}
              >

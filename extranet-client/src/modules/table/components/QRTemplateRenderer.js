...
export const QRTemplateRenderer = ({ template, table, qrUrl, qrSettings, logoSrc, logoDimensions, }) => {
    ...
    const drawContent = (ctx, canvas) => {
        ...
        const restaurantName = typeof table.restaurantId === 'string'
            ? 'Restaurant'
            : table.restaurantId?.name || 'Restaurant';
        const branchName = typeof table.branchId === 'string'
            ? restaurantName
            : table.branchId?.name || restaurantName;
    ...
    const imageSettings = logoSrc && logoDimensions
        ...
        : undefined;
    return (_jsxs("div", { style: { position: 'relative' }, children: [_jsx("div", { ref: qrCanvasRef, style: { position: 'absolute', left: '-9999px' }, children: _jsx(QRCodeCanvas, { value: qrUrl, size: 600, fgColor: qrSettings.fgColor, bgColor: qrSettings.bgColor, level: qrSettings.level, imageSettings: imageSettings }) }), _jsx("canvas", { ref: canvasRef, className: "qr-template-canvas", style: {
                    width: '100%',
                    maxWidth: '400px',
                    height: 'auto',
